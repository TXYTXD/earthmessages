      ...
      <section id="contact" className="py-20 md:py-28 px-6 bg-muted/10 border-y border-border/20">
        <div className="max-w-[560px] mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }} custom={0} variants={fadeUp} className="text-center mb-10">
            ...
            <a href="mailto:support@earthmessages.com" className="inline-flex items-center gap-2 text-[13px] font-medium text-primary hover:underline">
              <Mail className="w-4 h-4" /> support@earthmessages.com
            </a>
          </motion.div>
          <ContactForm />
        </div>
        ...
        <div className="max-w-[600px] mx-auto text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }} custom={0} variants={fadeUp}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Button variant="outline" size="lg" className="rounded-full px-8 text-sm h-11 border-border/50 text-muted-foreground" onClick={goAuth}>
                Log in
              </Button>
            </div>
          </motion.div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <a href="mailto:support@earthmessages.com" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1">
                <Mail className="w-3 h-3" /> support@earthmessages.com
              </a>
