  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-0">
        <div
          className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[520px] h-[520px] rounded-full opacity-25 blur-[120px]"
      ...
      >
        <div className="premium-card rounded-3xl p-7 text-center space-y-6">
          <div
            className="ring-halo w-16 h-16 rounded-2xl flex items-center justify-center mx-auto"
            style={{ background: "var(--messenger-gradient)" }}
          >
          ...
          <Button
            ...
            className="w-full h-12 rounded-xl font-medium text-sm gap-2 shadow-premium"
          >
            {loading ? (
