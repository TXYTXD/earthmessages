...
import { MessageCircle, Video, Phone, Settings, User, CircleDot, Bot, CalendarDays } from "lucide-react";
...
const navItems = [
  ...
  { icon: Bot, label: "AI Chat", path: "/ai" },
...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-[72px] h-screen flex-col items-center py-3 glass-nav border-r border-border/60">
      {/* Logo */}
