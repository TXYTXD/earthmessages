...
-- Fix call_records policies: change from RESTRICTIVE to PERMISSIVE
...
ON public.call_records AS PERMISSIVE
...
-- Fix call_signaling policies: change from RESTRICTIVE to PERMISSIVE
...
ON public.call_signaling AS PERMISSIVE
FOR INSERT TO authenticated
